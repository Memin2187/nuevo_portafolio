    ...
    <section>
      <div className="border-t border-muted">
        <div className="container">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 md:gap-11 py-6 md:py-7">
            {/* Contact Items */}
                ...
                (value: any, index: number) => (
                  ...
                  >
                    <Image
                      ...
                      width={24}
                      height={24}
                      className="min-w-[24px] min-h-[24px] dark:brightness-0 dark:invert"
                    />
